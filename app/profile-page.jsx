  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileSection}>
        <Text style={styles.nameText}>Paul Brice</Text>
        <Text style={styles.patientText}>Patient</Text>
        <View style={styles.detailItem}>
          <Feather name="hotel" size={20} color="#757575" />
          <Text style={styles.detailText}>Room 201</Text>
        </View>
        <View style={styles.detailItem}>
          <Feather name="smartphone" size={20} color="#757575" />
          <Text style={styles.detailText}>81</Text>
        </View>
      </View>

      <View style={styles.actionButtons}>
        <TouchableOpacity style={styles.actionButton}>
          <Feather name="id-card" size={20} color="#6759FF" />
          <Text style={styles.actionButtonText}>ID Management</Text>
        </TouchableOpacity>
